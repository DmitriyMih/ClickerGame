...
namespace SimpleResourcesSystem.SimpleItemSystem
{
    ...
    public class SimpleResourcesItemInfo : BaseResourceInfo
    {
        ...
        [field: SerializeField, LoadMarker(5)] public int MaximumResourcesCount5 { get; private set; } = 64;
        [field: SerializeField, LoadMarker(6)] public int MaximumResourcesCount6 { get; private set; } = 64;
        [field: SerializeField, LoadMarker(7)] public int MaximumResourcesCount7 { get; private set; } = 64;
        [field: SerializeField, LoadMarker(8)] public int MaximumResourcesCount8 { get; private set; } = 64;
    }
}